...
//Router Productos
router.get('/', admin_controllers_1.getProducts);
router.get('/:id', admin_controllers_1.getProduct);
router.post('/', admin_controllers_1.postProduct);
router.put('/:id', admin_controllers_1.putProduct);
router.delete('/:id', admin_controllers_1.deleteProduct);
//Router Motoristas
router.get('/', admin_controllers_1.getMotoristas);
...
//Router Clientes
router.get('/', admin_controllers_1.getClients);
...
//Router Empresas
router.get('/', admin_controllers_1.getCompanies);
...
//Router Ordenes
router.get('/', admin_controllers_1.getOrders);
